...
- Playwright config and Vite smoke specs are present under `frontend/`; smoke coverage includes the full assumptions section, but browser execution is blocked until dependencies are installed.
