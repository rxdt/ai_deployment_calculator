...
export function normalizedNumericState(
  ...
  const normalized: NumericState = {
    ...
    attentionHeads: defaults.attentionHeads,
    kvHeads: defaults.kvHeads,
    headDim: defaults.headDim,
    mlaLayers: defaults.mlaLayers,
    kdaLayers: defaults.kdaLayers,
    kvLoraRank: defaults.kvLoraRank,
    ropeHeadDim: defaults.ropeHeadDim,
