...
- Frontend app coverage asserts calculator render, submit, and adaptive
  rerender paths complete without calling `fetch`, guarding against
  report-service regressions.
