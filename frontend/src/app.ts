...
export type FormState = typeof DEFAULT_VALUES & {
  trained: boolean;
  use_adapter: boolean;
};
...
function syncAdapterControl(app: HTMLDivElement): void {
...
function syncArchitectureControl(app: HTMLDivElement): void {
